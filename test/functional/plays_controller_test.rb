...
class PlaysControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post :create, play: { notes: @play.notes, premiere_year: @play.premiere_year, title: @play.title }
    end
  ...
  test "should update play" do
    put :update, id: @play, play: { notes: @play.notes, premiere_year: @play.premiere_year, title: @play.title }
    assert_redirected_to play_path(assigns(:play))
  end
